/**
 * Recovery Exercise Card: Single-entry form for recovery exercises
 * Shows Duration/Intensity in a vertical form layout
 */
...
interface RecoveryExerciseCardProps {
  exerciseName: string
  definition: Exercise
  sets: WorkoutSet[]
...
export default function RecoveryExerciseCard({
  exerciseName,
  definition,
  sets,
  onSetChange,
  isLoading,
}: RecoveryExerciseCardProps) {
  ...
  return (
    <div className="recovery-exercise-card">
      ...
      <div className="exercise-body">
        ...
        {!isLoading && (
          <div className="single-entry-form">
            ...
            <div className={`recovery-form-row ${metric1Value !== null && currentSet.id !== 0 ? 'pre-filled' : ''}`}>
            ...
            <div className={`recovery-form-row ${metric2Value !== null && currentSet.id !== 0 ? 'pre-filled' : ''}`}>
